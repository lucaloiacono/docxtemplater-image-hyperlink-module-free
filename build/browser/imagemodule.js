...
module.exports = function () {
	...
	_createClass(ImgManager, [{
		...
		key: "addImageRels",
		value: function addImageRels(imageName, imageData, imageProps, i) {
			if (i == null) {
				i = 0;
			}
...
},{"./doc-utils.js":11,"./join-uncorrupt.js":17,"./lexer.js":18,"./parser.js":27,"./postrender.js":28,"./render.js":30,"./resolve.js":31,"./xml-matcher.js":35}],37:[function(require,module,exports){
function DOMParser(options){
	this.options = options ||{locator:{}};
}
...
},{}],"/build/node/index.js":[function(require,module,exports){
"use strict";
...
},{"./imgManager":2,"./templates":3,"docxtemplater":12,"xmldom":37}]},{},[])("/build/node/index.js")
});
